...
from fieldsSeesaw import seesawFields as fields
...
def createClasses(inFile, outFile):
    ...
    with open(inFile, 'r') as dataIn, open(outFile, 'w') as dataOut:
        ...
        for row in reader:
            ...
            new['Co-Teacher 1 Email'] = ''
            new['Co-Teacher 1 First Name'] = ''
            new['Co-Teacher 1 Last Name'] = ''
            new['Co-Teacher 2 Email'] = ''
            new['Co-Teacher 2 First Name'] = ''
            new['Co-Teacher 2 Last Name'] = ''
            new['Co-Teacher 3 Email'] = ''
...
def main():
    ...
    sourceClasses = f'{inputs}/Seesaw.csv'
    #CSV files for upload into Seesaw
    resultClasses = f'{results}/class_Rosters.csv'
